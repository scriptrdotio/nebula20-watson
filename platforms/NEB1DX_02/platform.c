...
const platform_gpio_t platform_gpio_pins[] =
{
    ...
    [WICED_GPIO_55] = { GPIOG,  4 },
    [WICED_GPIO_56] = { GPIOG,  6 },
...
{
    /* Determine which peripheral is currently using this DMA stream */
    uint32_t dmaChan = platform_uart_peripherals[WICED_UART_3].rx_dma_config.stream->CR & DMA_SxCR_CHSEL;
    if(dmaChan == platform_uart_peripherals[WICED_UART_3].rx_dma_config.channel){
