...
#endif
/*
NEB1DX_02 platform pin definitions ...
+---------------------------------------------------------------------------------------------------------+
...
|               |    |                  |               |      | CAN1_TX     |              |             |
|---------------+----+------------------+---------------+------+-------------+--------------+-------------|
| WICED_GPIO_13 | 46 |                  | WICED_GPIO_13 | B  0 | GPIO        | LED1_RED     | WICED_PWM_2 |
|               |    |                  |               |      | ADC12_IN8   |              |             |
|               |    |                  |               |      | TIM1_CH2N   |              |             |
|               |    |                  |               |      | TIM3_CH3    |              |             |
|               |    |                  |               |      | TIM8_CH2N   |              |             |
|               |    |                  |               |      | ETH_MII_RXD2|              |             |
|---------------+----+------------------+---------------+------+-------------+--------------+-------------|
| WICED_GPIO_14 | 47 |                  | WICED_GPIO_14 | B  1 | GPIO        | LED1_GREEN   | WICED_PWM_3 |
|               |    |                  |               |      | ADC12_IN9   |              |             |
|               |    |                  |               |      | TIM1_CH3N   |              |             |
|               |    |                  |               |      | TIM3_CH4    |              |             |
|               |    |                  |               |      | TIM8_CH3N   |              |             |
|               |    |                  |               |      | ETH_MII_RXD3|              |             |
|---------------+----+------------------+---------------+------+-------------+--------------+-------------|
| WICED_GPIO_15 | 48 |                  | WICED_GPIO_15 | B  2 | GPIO        | LED2_RED     |             |
|               |    |                  |               |      |             |              |             |
|---------------+----+------------------+---------------+------+-------------+--------------+-------------|
...
|               |    |                  |               |      | OTG_HS_DP   |              |             |
|---------------+----+------------------+----------------------+-------------+--------------+-------------|
| WICED_GPIO_22 | 27 |                  | WICED_GPIO_22 | C  1 | GPIO        | MIKRO_INT    |             |
|               |    |                  |               |      | ADC123_IN11 |              |             |
|               |    |                  |               |      | ETH_MDC     |              |             |
|---------------+----+------------------+---------------+------+-------------+--------------+-------------|
...
|               |    |                  |               |      | ADC3_IN8    |              |             |
|---------------+----+------------------+---------------+------+-------------+--------------+-------------|
| WICED_GPIO_54 | 49 |                  | WICED_GPIO_54 | F 11 | GPIO        | LED2_GREEN   |             |
|               |    |                  |               |      | SPI5_MOSI   |              |             |
|---------------+----+------------------+---------------+------+-------------+--------------+-------------|
| WICED_GPIO_55 | 89 |                  | WICED_GPIO_55 | G  4 | GPIO        | USER_BUTTON2 |             |
|---------------+----+------------------+---------------+------+-------------+--------------+-------------|
| WICED_GPIO_56 | 91 |                  | WICED_GPIO_56 | G  6 | GPIO        | USER_BUTTON1 |             |
|---------------+----+------------------+---------------+------+-------------+--------------+-------------|
...
#define WICED_LED3          ( WICED_GPIO_15 )
#define WICED_LED4          ( WICED_GPIO_54 )
...
#define WICED_BUTTON1       ( WICED_GPIO_56 )
#define WICED_BUTTON2       ( WICED_GPIO_55 )
#define WICED_THERMISTOR    ( WICED_GPIO_53 )

/* I/O connection <-> Peripheral Connections */
#define WICED_LED1_JOINS_PWM        ( WICED_PWM_2 )
#define WICED_LED2_JOINS_PWM        ( WICED_PWM_3 )
