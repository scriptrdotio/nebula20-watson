...
/** @file
 * Defines internal configuration of the NEB1DX_01 board
 */
#pragma once
...
/*  Internal flash wait state : 5 cycles */
#define INT_FLASH_WAIT_STATE ( FLASH_Latency_5 )

/*  Internal flash voltage range : 2.7 to 3.6V */
#define PLATFORM_STM32_VOLTAGE_2V7_TO_3V6

/* Define watchdog timeout multiplier since it isn't automatically defined for this clock freq */
#define DBG_WATCHDOG_TIMEOUT_MULTIPLIER       (3150)
